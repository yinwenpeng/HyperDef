...
def evaluate_lenet5(learning_rate=0.02, n_epochs=4, L2_weight=1e-5, extra_size=4, emb_size=300, batch_size=100, filter_size=[3,3], maxSentLen=40, hidden_size=[300,300], max_term_len=4, p_mode = 'conc'):
    ...
    test_sents_l, test_masks_l, test_sents_r, test_masks_r, test_word1,test_word2,test_word1_mask,test_word2_mask,test_labels, test_extra, word2id, group_size_list = load_task_hyper_vs_all_with_allDefComb(BLESS_file,maxSentLen, word2id, wordlen=max_term_len)
    ...
    0.515935866189; current ap: 0.477302302904 ap@100 0.886327319513
    0.55216101148; current ap: 0.48810020251 ap@100 0.854880147634
    0.627138977606; current ap: 0.537109706588 ap@100 0.775782901608
    '''
