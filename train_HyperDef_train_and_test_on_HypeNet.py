...
'''
lex
current test_f1: 0.745954083553 0.749621785174 0.742322097378
current test_f1: 0.77312 0.913767019667 0.669994453688

rnd:
current test_f1: 0.907973746683 0.925683371298 0.89092902165
current test_f1: 0.913135294946 0.92340546697 0.903091060986
current test_f1: 0.913388016127 0.935364464692 0.892420537897
'''
...
def evaluate_lenet5(learning_rate=0.02, n_epochs=4, L2_weight=1e-5, extra_size=4, emb_size=300, batch_size=100, filter_size=[3,3], maxSentLen=40, hidden_size=[300,300], max_term_len=4, p_mode = 'conc'):
    ...
    all_sentences_l, all_masks_l, all_sentences_r, all_masks_r, all_word1,all_word2,all_word1_mask,all_word2_mask,all_labels, all_extra, word2id  =load_HypeNet_testset(root,'train',maxSentLen, {}, wordlen=max_term_len)  #minlen, include one label, at least one word in the sentence
    ...
    while epoch < n_epochs:
        ...
        for batch_id in train_batch_start: #for each batch
            ...
            if iter%10==0:
                ...
                if test_f1 > max_f1:
                    max_f1=test_f1
                    store_model_to_file(root+'Best_para_finetune_'+str(max_f1), params)
