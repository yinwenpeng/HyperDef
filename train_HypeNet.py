...
from load_data import store_word2id, load_SNLI_dataset, write_predictions_to_analysis,load_HypeNet_trainset,load_word2vec, load_word2vec_to_init, load_HypeNet_testset
...
def evaluate_lenet5(learning_rate=0.02, n_epochs=100, L2_weight=1e-5, extra_size=4, emb_size=300, batch_size=20, filter_size=[3,3], maxSentLen=40, hidden_size=[300,300], max_term_len=4, p_mode = 'conc'):
    ...
    all_sentences_l, all_masks_l, all_sentences_r, all_masks_r, all_word1,all_word2,all_word1_mask,all_word2_mask,all_labels, all_extra, word2id  =load_HypeNet_trainset(maxlen=maxSentLen, wordlen=max_term_len)  #minlen, include one label, at least one word in the sentence
    ...
    while epoch < n_epochs:
        ...
        for batch_id in train_batch_start: #for each batch
            ...
            if iter%40==0:
                ...
                test_f1, test_recall, test_precision = f1_score_binary(test_labels, pred_labels)


                if test_f1 > max_f1:
                    max_f1=test_f1
                    # store_model_to_file('/save/wenpeng/datasets/EVALution/HyperDef_label_4ways_conc_best_para_'+str(max_ap_test), params)
                print '\t\tcurrent test_f1:', test_f1,test_recall, test_precision,' ; ','\t\tmax_f1: ', max_f1
